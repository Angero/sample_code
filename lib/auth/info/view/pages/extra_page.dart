...
class ExtraPage extends StatelessWidget {
      ...
      child: DownButtonPanel(
        ...
        onClick: () {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) {
                return MainPage(currentIndex: 4);
              },
            ),
          );
        },
  ...
  Column _contentWidget(BuildContext context) {
    return Column(
      children: [
        HeaderWidget(title: 'Personal info', step: 6),
        SizedBox(height: 20.0),
        SubHeaderWidget(
          title: 'Tell us more about your extracurricular',
          subtitle: 'You can make your job search so much easier',
        ),
        SizedBox(height: 45.0),
        CirclesTitle(title: 'Choose your extracurricular '.toUpperCase()),
